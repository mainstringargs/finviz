...
#https://finviz.com/screener.ashx?v=111&f=fa_epsqoq_o5,fa_salesqoq_o5,geo_usa,sh_instown_o10,ta_averagetruerange_o2.5,ta_sma20_pa,ta_sma200_pa,ta_sma50_pa&ft=4
    ...
    filters = ['cap_midunder','fa_epsqoq_o5','fa_salesqoq_o5','geo_usa','sh_instown_o10','ta_averagetruerange_o2.5','ta_sma20_pa','ta_sma200_pa','ta_sma50_pa']  # Shows companies in NASDAQ which are in the S&P500
